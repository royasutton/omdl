...
[
  [  "1/8",  "3",l_in( 0.41),l_mm( 10.29),l_in(0.068),l_in(0.095),l_in(0.000)],
  [  "1/4",  "6",l_in( 0.54),l_mm( 13.72),l_in(0.088),l_in(0.119),l_in(0.000)],
  [  "3/8", "10",l_in( 0.68),l_mm( 17.15),l_in(0.091),l_in(0.126),l_in(0.000)],
  ...
  ["3-1/2", "90",l_in( 4.00),l_mm(102.00),l_in(0.226),l_in(0.318),l_in(0.000)],
  [    "4","100",l_in( 4.50),l_mm(114.00),l_in(0.237),l_in(0.337),l_in(0.437)],
  [    "5","125",l_in( 5.56),l_mm(141.00),l_in(0.258),l_in(0.375),l_in(0.000)],
  [    "6","150",l_in( 6.63),l_mm(168.00),l_in(0.280),l_in(0.432),l_in(0.562)],
  [    "8","200",l_in( 8.63),l_mm(219.00),l_in(0.322),l_in(0.500),l_in(0.000)],
  [   "10","250",l_in(10.75),l_mm(273.00),l_in(0.365),l_in(0.593),l_in(0.000)],
  [   "12","300",l_in(12.75),l_mm(324.00),l_in(0.406),l_in(0.687),l_in(0.000)],
  [   "14","350",l_in(14.00),l_mm(355.60),l_in(0.437),l_in(0.750),l_in(0.000)],
  [   "16","400",l_in(16.00),l_mm(406.40),l_in(0.500),l_in(0.843),l_in(0.000)],
  [   "18","450",l_in(18.00),l_mm(457.20),l_in(0.562),l_in(0.937),l_in(0.000)],
  [   "20","500",l_in(20.00),l_mm(508.00),l_in(0.593),l_in(1.031),l_in(0.000)],
  [   "24","600",l_in(24.00),l_mm(610.00),l_in(0.687),l_in(1.218),l_in(0.000)]
];
