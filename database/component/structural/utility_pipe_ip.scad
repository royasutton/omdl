...
[
  ...
  ["3-1/2", "90",l_in( 4.000),l_mm(102.0),l_in(0.216),l_in(0.300),l_in(0.000),l_in(0.000)],
  ...
  [   "10","250",l_in(10.750),l_mm(273.0),l_in(0.365),l_in(0.593),l_in(1.125),l_in(0.000)],
  [   "12","300",l_in(12.750),l_mm(324.0),l_in(0.406),l_in(0.687),l_in(1.312),l_in(0.000)],
  [   "14","350",l_in(14.000),l_mm(356.0),l_in(0.438),l_in(0.750),l_in(1.406),l_in(0.000)],
  [   "16","400",l_in(16.000),l_mm(406.0),l_in(0.500),l_in(0.843),l_in(1.596),l_in(0.000)],
  [   "18","450",l_in(18.000),l_mm(457.0),l_in(0.562),l_in(0.937),l_in(1.781),l_in(0.000)],
  [   "20","500",l_in(20.000),l_mm(508.0),l_in(0.593),l_in(0.937),l_in(1.968),l_in(0.000)],
  [   "24","600",l_in(24.000),l_mm(610.0),l_in(0.687),l_in(1.218),l_in(2.343),l_in(0.000)]
];
