...
[
  ["M1.6",l_mm(0.35),l_mm(  9),l_mm(  0),l_mm(0.25),l_mm(0.10),l_mm( 2.0),l_mm(0.6),l_mm( 2.27),l_mm( 1.225),l_mm( 0.975),l_mm( 3.2),l_mm( 3.02),l_mm( 3.41),l_mm( 0.68)],
  [  "M2",l_mm(0.40),l_mm( 10),l_mm(  0),l_mm(0.25),l_mm(0.10),l_mm( 2.6),l_mm(0.8),l_mm( 3.07),l_mm( 1.525),l_mm( 1.275),l_mm( 4.0),l_mm( 3.82),l_mm( 4.32),l_mm( 0.89)],
  ["M2.5",l_mm(0.45),l_mm( 11),l_mm(  0),l_mm(0.25),l_mm(0.10),l_mm( 3.1),l_mm(1.0),l_mm( 4.07),l_mm( 1.825),l_mm( 1.575),l_mm( 5.0),l_mm( 4.82),l_mm( 5.45),l_mm( 1.10)],
  [  "M3",l_mm(0.50),l_mm( 12),l_mm(  0),l_mm(0.40),l_mm(0.15),l_mm( 3.6),l_mm(1.0),l_mm( 4.57),l_mm( 2.125),l_mm( 1.875),l_mm( 5.5),l_mm( 5.32),l_mm( 6.01),l_mm( 1.31)],
  [  "M4",l_mm(0.70),l_mm( 14),l_mm(  0),l_mm(0.40),l_mm(0.15),l_mm( 4.7),l_mm(1.2),l_mm( 5.88),l_mm( 2.925),l_mm( 2.675),l_mm( 7.0),l_mm( 6.78),l_mm( 7.66),l_mm( 1.87)],
  [  "M5",l_mm(0.80),l_mm( 16),l_mm(  0),l_mm(0.50),l_mm(0.15),l_mm( 5.7),l_mm(1.2),l_mm( 6.88),l_mm( 3.650),l_mm( 3.350),l_mm( 8.0),l_mm( 7.78),l_mm( 8.79),l_mm( 2.35)],
  [  "M6",l_mm(1.00),l_mm( 18),l_mm(  0),l_mm(0.50),l_mm(0.15),l_mm( 6.8),l_mm(1.4),l_mm( 8.88),l_mm( 4.150),l_mm( 3.850),l_mm(10.0),l_mm( 9.78),l_mm(11.05),l_mm( 2.70)],
  [  "M8",l_mm(1.25),l_mm( 22),l_mm(  0),l_mm(0.60),l_mm(0.15),l_mm( 9.2),l_mm(2.0),l_mm(11.63),l_mm( 5.450),l_mm( 5.150),l_mm(13.0),l_mm(12.73),l_mm(14.38),l_mm( 3.61)],
  [ "M10",l_mm(1.50),l_mm( 26),l_mm(  0),l_mm(0.60),l_mm(0.15),l_mm(11.2),l_mm(2.0),l_mm(14.63),l_mm( 6.580),l_mm( 6.220),l_mm(16.0),l_mm(15.73),l_mm(17.77),l_mm( 4.35)],
  [ "M12",l_mm(1.75),l_mm( 30),l_mm(  0),l_mm(0.60),l_mm(0.15),l_mm(13.7),l_mm(3.0),l_mm(16.63),l_mm( 7.680),l_mm( 7.320),l_mm(18.0),l_mm(17.73),l_mm(20.03),l_mm( 5.12)],
