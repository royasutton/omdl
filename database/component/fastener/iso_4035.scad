...
[
  ["M1.6",0.35/l_mm(1),l_mm( 3.20),l_mm( 3.02),l_mm( 3.41),l_mm( 1.00),l_mm( 0.75)],
  [  "M2",0.40/l_mm(1),l_mm( 4.00),l_mm( 3.82),l_mm( 4.32),l_mm( 1.20),l_mm( 0.95)],
  ["M2.5",0.45/l_mm(1),l_mm( 5.00),l_mm( 4.82),l_mm( 5.45),l_mm( 1.60),l_mm( 1.35)],
  [  "M3",0.50/l_mm(1),l_mm( 5.50),l_mm( 5.32),l_mm( 6.01),l_mm( 1.80),l_mm( 1.55)],
  [  "M4",0.70/l_mm(1),l_mm( 7.00),l_mm( 6.78),l_mm( 7.66),l_mm( 2.20),l_mm( 1.95)],
  [  "M5",0.80/l_mm(1),l_mm( 8.00),l_mm( 7.78),l_mm( 8.79),l_mm( 2.70),l_mm( 2.45)],
  [  "M6",1.00/l_mm(1),l_mm(10.00),l_mm( 9.78),l_mm(11.05),l_mm( 3.20),l_mm( 2.90)],
  [  "M8",1.25/l_mm(1),l_mm(13.00),l_mm(12.73),l_mm(14.38),l_mm( 4.00),l_mm( 3.70)],
  [ "M10",1.50/l_mm(1),l_mm(16.00),l_mm(15.73),l_mm(17.77),l_mm( 5.00),l_mm( 4.70)],
  [ "M12",1.75/l_mm(1),l_mm(18.00),l_mm(17.73),l_mm(20.03),l_mm( 6.00),l_mm( 5.70)],
  [ "M14",2.00/l_mm(1),l_mm(21.00),l_mm(20.67),l_mm(23.35),l_mm( 7.00),l_mm( 6.42)],
  [ "M16",2.00/l_mm(1),l_mm(24.00),l_mm(23.67),l_mm(26.75),l_mm( 8.00),l_mm( 7.42)],
  [ "M20",2.50/l_mm(1),l_mm(30.00),l_mm(29.16),l_mm(32.95),l_mm(10.00),l_mm( 9.10)],
  [ "M24",3.00/l_mm(1),l_mm(36.00),l_mm(35.00),l_mm(39.55),l_mm(12.00),l_mm(10.90)],
  [ "M30",3.50/l_mm(1),l_mm(46.00),l_mm(45.00),l_mm(50.85),l_mm(15.00),l_mm(13.90)],
  [ "M36",4.00/l_mm(1),l_mm(55.00),l_mm(53.80),l_mm(60.79),l_mm(18.00),l_mm(16.90)],
  [ "M42",4.50/l_mm(1),l_mm(65.00),l_mm(63.10),l_mm(71.30),l_mm(21.00),l_mm(19.70)],
  [ "M48",5.00/l_mm(1),l_mm(75.00),l_mm(73.10),l_mm(82.60),l_mm(24.00),l_mm(22.70)]
];
