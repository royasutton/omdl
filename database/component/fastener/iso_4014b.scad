...
[
  ["M16",l_mm(2.0),l_mm(  44),l_mm(   0),l_mm(0.8),l_mm(0.2),l_mm(17.7),l_mm(  3),l_mm(22.00),l_mm(10.29),l_mm( 9.71),l_mm( 24),l_mm(23.16),l_mm( 26.17),l_mm( 6.80)],
  ["M20",l_mm(2.5),l_mm(  52),l_mm(   0),l_mm(0.8),l_mm(0.2),l_mm(22.4),l_mm(  4),l_mm(27.70),l_mm(12.85),l_mm(12.15),l_mm( 30),l_mm(29.16),l_mm( 32.95),l_mm( 8.51)],
  ...
  ["M56",l_mm(5.5),l_mm(   0),l_mm( 137),l_mm(1.0),l_mm(0.3),l_mm(63.0),l_mm( 12),l_mm(78.66),l_mm(35.50),l_mm(34.50),l_mm( 85),l_mm(82.80),l_mm( 93.56),l_mm(24.15)],
  ["M64",l_mm(6.0),l_mm(   0),l_mm( 153),l_mm(1.0),l_mm(0.3),l_mm(71.0),l_mm( 13),l_mm(88.16),l_mm(40.50),l_mm(39.50),l_mm( 95),l_mm(92.80),l_mm(104.86),l_mm(27.65)]
];
