...
[
  ["M1.6",l_mm(0.35),l_mm( 3.00),l_mm( 2.70),l_mm(1.00),l_mm( 1.60),l_mm(0.9),l_mm(0.6),l_mm(0.7),0.0],
  [  "M2",l_mm(0.40),l_mm( 3.80),l_mm( 3.50),l_mm(1.20),l_mm( 1.90),l_mm(1.2),l_mm(0.9),l_mm(0.8),0.0],
  ["M2.5",l_mm(0.45),l_mm( 4.70),l_mm( 4.40),l_mm(1.50),l_mm( 2.90),l_mm(1.8),l_mm(1.4),l_mm(0.9),1.0],
  [  "M3",l_mm(0.50),l_mm( 5.50),l_mm( 5.20),l_mm(1.65),l_mm( 3.20),l_mm(2.1),l_mm(1.7),l_mm(1.0),1.0],
  [  "M4",l_mm(0.70),l_mm( 8.40),l_mm( 8.04),l_mm(2.70),l_mm( 4.60),l_mm(2.6),l_mm(2.1),l_mm(1.4),2.0],
  [  "M5",l_mm(0.80),l_mm( 9.30),l_mm( 8.94),l_mm(2.70),l_mm( 5.20),l_mm(3.2),l_mm(2.7),l_mm(1.6),2.0],
  [  "M6",l_mm(1.00),l_mm(11.30),l_mm(10.87),l_mm(3.30),l_mm( 6.80),l_mm(3.5),l_mm(3.0),l_mm(2.0),3.0],
  [  "M8",l_mm(1.25),l_mm(15.80),l_mm(15.37),l_mm(4.65),l_mm( 8.90),l_mm(4.6),l_mm(4.0),l_mm(2.5),4.0],
  [ "M10",l_mm(1.50),l_mm(18.30),l_mm(17.78),l_mm(5.00),l_mm(10.00),l_mm(5.7),l_mm(5.1),l_mm(3.0),4.0]
];
