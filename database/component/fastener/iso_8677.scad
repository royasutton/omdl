...
[
  [ "M5",l_mm(0.80),l_mm( 5.48),l_mm( 4.52),l_mm( 5.9),l_mm( 4.1),l_mm( 2.9),l_mm(13.00),l_mm(11.9),l_mm( 3.1),l_mm( 2.50),l_mm(16.00),l_mm( 0.00),l_mm( 0.00)],
  [ "M6",l_mm(1.00),l_mm( 6.48),l_mm( 5.52),l_mm( 7.2),l_mm( 4.6),l_mm( 3.4),l_mm(16.00),l_mm(14.9),l_mm( 3.6),l_mm( 3.00),l_mm(18.00),l_mm( 0.00),l_mm( 0.00)],
  [ "M8",l_mm(1.25),l_mm( 8.58),l_mm( 7.42),l_mm( 9.6),l_mm( 5.6),l_mm( 4.4),l_mm(20.00),l_mm(18.7),l_mm( 4.8),l_mm( 4.00),l_mm(22.00),l_mm(28.00),l_mm( 0.00)],
  ["M10",l_mm(1.50),l_mm(10.58),l_mm( 9.42),l_mm(12.2),l_mm( 6.6),l_mm( 5.4),l_mm(24.00),l_mm(22.7),l_mm( 5.8),l_mm( 5.00),l_mm(26.00),l_mm(32.00),l_mm( 0.00)],
  ["M12",l_mm(1.75),l_mm(12.70),l_mm(11.30),l_mm(14.7),l_mm( 8.8),l_mm( 7.2),l_mm(30.00),l_mm(28.7),l_mm( 6.8),l_mm( 6.00),l_mm(30.00),l_mm(36.00),l_mm( 0.00)],
  ["M16",l_mm(2.00),l_mm(16.70),l_mm(15.30),l_mm(19.9),l_mm(12.9),l_mm(11.1),l_mm(38.00),l_mm(36.4),l_mm( 8.9),l_mm( 8.00),l_mm(38.00),l_mm(44.00),l_mm(57.00)],
  ["M20",l_mm(2.50),l_mm(20.84),l_mm(19.16),l_mm(24.9),l_mm(15.9),l_mm(14.1),l_mm(46.00),l_mm(44.4),l_mm(10.9),l_mm(10.00),l_mm(46.00),l_mm(52.00),l_mm(65.00)]
];
