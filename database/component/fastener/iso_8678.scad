...
[
  [ "M6",l_mm(1.00),l_mm( 6.48),l_mm( 5.88),l_mm( 7.64),l_mm(3.0),l_mm(2.4),l_mm(14.20),l_mm(12.2),l_mm( 3.6),l_mm( 3.00),l_mm(18.00),l_mm( 0.00)],
  [ "M8",l_mm(1.25),l_mm( 8.58),l_mm( 7.85),l_mm(10.20),l_mm(3.0),l_mm(2.4),l_mm(18.00),l_mm(15.8),l_mm( 4.8),l_mm( 4.00),l_mm(22.00),l_mm(28.00)],
  ["M10",l_mm(1.50),l_mm(10.58),l_mm( 9.85),l_mm(12.80),l_mm(4.0),l_mm(3.2),l_mm(22.30),l_mm(19.6),l_mm( 5.8),l_mm( 5.00),l_mm(26.00),l_mm(32.00)],
  ["M12",l_mm(1.75),l_mm(12.70),l_mm(11.82),l_mm(15.37),l_mm(4.0),l_mm(3.2),l_mm(26.60),l_mm(23.8),l_mm( 6.8),l_mm( 6.00),l_mm(30.00),l_mm(36.00)],
  ["M16",l_mm(2.00),l_mm(16.70),l_mm(15.82),l_mm(20.57),l_mm(5.0),l_mm(4.2),l_mm(35.00),l_mm(31.9),l_mm( 8.9),l_mm( 8.00),l_mm(38.00),l_mm(44.00)],
  ["M20",l_mm(2.50),l_mm(20.84),l_mm(19.79),l_mm(25.73),l_mm(5.0),l_mm(4.2),l_mm(43.00),l_mm(39.9),l_mm(10.9),l_mm(10.00),l_mm(46.00),l_mm(52.00)]
];
