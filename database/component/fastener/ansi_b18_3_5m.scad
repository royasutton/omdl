...
[
  [ "M3",0.50/l_mm(1),l_mm( 3.00),l_mm(2.86),l_mm( 6.72),l_mm( 5.35),l_mm(1.86),l_mm(0.30),l_mm(2.0),l_mm(1.1),l_mm(0.25),l_mm(0.3)],
  [ "M4",0.70/l_mm(1),l_mm( 4.00),l_mm(3.82),l_mm( 8.96),l_mm( 7.80),l_mm(2.48),l_mm(0.30),l_mm(2.5),l_mm(1.5),l_mm(0.45),l_mm(0.4)],
  [ "M5",0.80/l_mm(1),l_mm( 5.00),l_mm(4.82),l_mm(11.20),l_mm( 9.75),l_mm(3.10),l_mm(0.35),l_mm(3.0),l_mm(1.9),l_mm(0.66),l_mm(0.5)],
  [ "M6",1.00/l_mm(1),l_mm( 6.00),l_mm(5.82),l_mm(13.44),l_mm(11.70),l_mm(3.72),l_mm(0.35),l_mm(4.0),l_mm(2.2),l_mm(0.70),l_mm(0.6)],
  [ "M8",1.25/l_mm(1),l_mm( 8.00),l_mm(7.78),l_mm(17.92),l_mm(15.60),l_mm(4.96),l_mm(0.40),l_mm(5.0),l_mm(3.0),l_mm(1.16),l_mm(0.8)],
  ["M10",1.50/l_mm(1),l_mm(10.00),l_mm(9.78),l_mm(22.40),l_mm(19.50),l_mm(6.20),l_mm(0.50),l_mm(6.0),l_mm(3.6),l_mm(1.62),l_mm(0.9)]
];
