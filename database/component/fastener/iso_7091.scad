...
//! <map> ISO 7091 fastener data table columns map.
//! \hideinitializer
...
//! \<table> ISO 7091 fastener data table rows.
//! \hideinitializer
dtr_fastener_metric_washers_iso_7091 =
[
  [ "5",l_mm( 5.80),l_mm( 5.50),l_mm(10.00),l_mm( 9.1),l_mm(1.2),l_mm(0.8)],
  [ "6",l_mm( 6.96),l_mm( 6.60),l_mm(12.00),l_mm(10.9),l_mm(1.9),l_mm(1.3)],
  [ "8",l_mm( 9.36),l_mm( 9.00),l_mm(16.00),l_mm(14.9),l_mm(1.9),l_mm(1.3)],
  ["10",l_mm(11.43),l_mm(11.00),l_mm(20.00),l_mm(18.7),l_mm(2.3),l_mm(1.7)],
  ["12",l_mm(13.93),l_mm(13.50),l_mm(24.00),l_mm(22.7),l_mm(2.8),l_mm(2.2)],
  ["14",l_mm(15.93),l_mm(15.50),l_mm(28.00),l_mm(26.7),l_mm(2.8),l_mm(2.2)],
  ["16",l_mm(17.93),l_mm(17.50),l_mm(30.00),l_mm(28.7),l_mm(3.6),l_mm(2.4)],
  ["20",l_mm(22.52),l_mm(22.00),l_mm(37.00),l_mm(35.4),l_mm(3.6),l_mm(2.4)],
  ["24",l_mm(26.52),l_mm(26.00),l_mm(44.00),l_mm(42.4),l_mm(4.6),l_mm(3.4)],
  ["30",l_mm(33.62),l_mm(33.00),l_mm(56.00),l_mm(54.1),l_mm(4.6),l_mm(3.4)],
  ["36",l_mm(40.00),l_mm(39.00),l_mm(66.00),l_mm(64.1),l_mm(6.0),l_mm(4.0)]
];
