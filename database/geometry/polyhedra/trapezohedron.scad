//! Table of polyhedra data group: \c trapezohedron
/***************************************************************************//**
...
/***************************************************************************//**
  ...
  @{
    ...
    \amu_define caption (trapezohedron)
    ...
    \amu_shell data
      (
        "grep -Po 'ECHO: \"\K[^\"]*' build/csg/trapezohedron_db_autostat.log" --rmnl
      )
...
//! \<table> \c trapezohedron polyhedra data table columns definition.
