//! Table of polyhedra data group: \c anti_prisms
/***************************************************************************//**
...
/***************************************************************************//**
  ...
  @{
    ...
    \amu_define caption (anti_prisms)
    ...
    \amu_define caption (anti\_prisms)
    ...
    \amu_shell data
      (
        "grep -Po 'ECHO: \"\K[^\"]*' build/csg/anti_prisms_db_autostat.log" --rmnl
      )
...
//! \<table> \c anti_prisms polyhedra data table columns definition.
...
BEGIN_SCOPE autostat;
  BEGIN_OPENSCAD;
    ...
    include <table.scad>;
    include <database/polyhedra/anti_prisms.scad>;
