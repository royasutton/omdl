...
)
{
  ...
  if ( s1 )
  {
    ...
    { // circle
      hull_cs( !s2 )
      for ( ls = sequence_ns( polygon_arc_sweep_p( r=al/3, o=pah, fn=$draft_arrow_fn ), 2, 1 ) )
    ...
    { // line break(s)
      ...
      [
        ...
        (
          ...
          xp = polygon_regular_p(n=2, r=s4, ao=la+s5, o=mp),
          lp = polygon_regular_p(n=2, r=s3, ao=la, o=mp)
        )
        [ lp[1], xp[0], xp[1], lp[0] ]
      ];
...
/***************************************************************************//**
  \copydetails polygon_arc_sweep_p()
